...
public class LaserHandle : XRBaseInteractable
{
    ...
    [SerializeField]
    RotationAxis m_currentRotationAxis = RotationAxis.YAxis;
    [SerializeField]  float startRotPosX = 0f, startRotPosZ = 0f;
    ...
    void SetKnobRotation(float angle)
    {
        ...
        if (m_Handle != null)
        {
                ...
                m_Handle.localEulerAngles = new Vector3(0, angle, 0);
        }
